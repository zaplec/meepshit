local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/zaplec/meepshit/main/ui-engine.lua"))()
...
hori:AddButton("Fuck",function()
	NBox:Set(game:HttpGet("https://raw.githubusercontent.com/zaplec/meepshit/main/f.lua"))
end)
